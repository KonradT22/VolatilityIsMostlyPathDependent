...
def main():
    ...
    for beta1 in [-0.20, -0.16, -0.13, -0.10, -0.07]:
        cases.append((f"beta1_{beta1:+.2f}", [base[0], beta1, base[2]]))

    for beta2 in [0.50, 0.60, 0.65, 0.75, 0.85]:
        cases.append((f"beta2_{beta2:.2f}", [base[0], base[1], beta2]))
    ...
    rows_path = outdir / "pdv_parameter_sweep_30d_rows.csv"
    summary_path = outdir / "pdv_parameter_sweep_30d_summary.csv"
    ...
    print()
    print("Sweep summary sorted by objective_score:")
    print(summary)
